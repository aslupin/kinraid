...
class App extends Component {
  constructor(props){
    ...
    this.state = {
      ...
      res: [
        ['บาร์ใหม่','ประเภทร้าน: บาร์/โรงอาหาร','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ม.เกษตร'],
        ['บาร์ใหม่กว่า','ประเภทร้าน: บาร์/โรงอาหาร','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ม.เกษตร'],
        ['บาร์วิศวะ (IUP)','ประเภทร้าน: บาร์/โรงอาหาร','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ม.เกษตร'],
        ['บาร์บริหาร (BUS)','ประเภทร้าน: บาร์/โรงอาหาร','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ม.เกษตร'],
        ['บาร์วิทย์','ประเภทร้าน: บาร์/โรงอาหาร','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ม.เกษตร'],
        ['ร้านชมจันทร์','ประเภทร้าน: ร้านอาหารตามสั่ง','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ตรงข้ามประตู 1 ม.เกษตร'],
        ['ร้านแซม','ประเภทร้าน: สเต็ก','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ฝั่งตรงข้าม ม.เกษตร ก่อนถึงตลาดอมรภัณฑ์'],
        ['ร้านกอลิล่า','ประเภทร้าน: สเต็ก','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ตลาดอมรภัณฑ์'],
        ['ร้านพี่กร ซอย54','ประเภทร้าน: ร้านอาหารตามสั่ง','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ตรงข้าม ม.เกษตร ซอย52'],
        ['ร้านสี่แยก ซอย52','ประเภทร้าน: ร้านอาหารตามสั่ง','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ตรงข้าม ม.เกษตร ซอย52'],
        ['ตลาดอมรภัณฑ์','ประเภทร้าน: ตลาด','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ตลาดอมรภัณฑ์'],
        ['ร้านข้าวมันไก่ ซอย52','ประเภทร้าน: ร้านข้าวมันไก่','เวลาเปิด/ปิด: 8.00 - 21.00 น.','ตำแหน่ง: ตรงข้าม ม.เกษตร ซอย52']
